...
<a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-white focus:text-indigo-700 focus:font-semibold focus:rounded focus:outline focus:outline-2 focus:outline-indigo-700">Skip to main content</a>
    ...
    <nav x-data="{ open: false }" aria-label="Main navigation"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
            ...
            <a href="{{ route('home') }}" aria-label="EventAgile — go to home page"
                class="text-xl font-bold text-indigo-600">EventAgile</a>
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('signup') }}"
                    class="hidden md:inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-indigo-600 min-h-[44px]">
                    Get Started Free
                </a>
                <button @click="open = !open"
                    ...
                    class="md:hidden p-2 rounded-lg text-gray-500 hover:bg-gray-100 focus:outline focus:outline-2 focus:outline-indigo-600 min-w-[44px] min-h-[44px]">
        ...
        <div id="mobile-menu" x-show="open" x-transition class="md:hidden border-t border-gray-200">
            <ul class="flex flex-col px-4 py-3 gap-2 text-sm font-medium text-gray-700">
                ...
                <li>
                    <a href="contact.html"
                        class="block mt-2 px-4 py-2 bg-indigo-600 text-white text-center rounded-lg hover:bg-indigo-700 min-h-[44px] flex items-center justify-center">
                        Get Started Free
                    </a>
                </li>
            </ul>
