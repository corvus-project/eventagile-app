...
<x-layouts.admin>
    ...
    <x-slot name="title">
        {{ __('dashboard.Event Detail') . $event->title }}
    </x-slot>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded p-6">
        ...
        <div class="mb-4">
            <strong>{{ __('dashboard.Title') }}</strong> {{ $event->title }}
        </div>
        <div class="mb-4">
            <strong>{{ __('dashboard.Date') }}</strong> {{ $event->start_time->format('F j, Y') }}
        </div>
        <div class="mb-4">
            <strong>{{ __('dashboard.Registration Ends At') }}:</strong> {{ $event->registration_ends_at?->format('F j, Y') }}
        </div>
        <div class="mb-4">
            <strong>{{ __('dashboard.Location') }}:</strong> {{ $event->location }}
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            <strong>{{ __('dashboard.Registration Link') }}:</strong>
