...
<main id="main-content" tabindex="-1">
                ...
                <div class="bg-white rounded-2xl shadow-md p-8">
                    <div class="flex items-center gap-4 mb-4">
                        <div
                            ...
                            <svg aria-hidden="true" class="w-7 h-7 text-blue-600" fill="none"
                    ...
                    <div class="bg-blue-50 rounded-lg p-4">
                        <p class="text-xs font-semibold text-blue-700 uppercase tracking-wide">How it works</p>
    ...
    <section class="py-16 px-4 sm:px-6 lg:px-8 bg-blue-600">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-base text-blue-100 leading-relaxed mb-8">Start your free trial today and see how
