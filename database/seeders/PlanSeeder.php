    ...
    public function run(): void
    {
        $plans = [
            ...
            [
                ...
                'interval' => 'month',
                'interval_count' => 1,
                'features' => json_encode(['Confirmation, reminder, and follow-up emails', 'Access to all features', 'Priority email support', 'Team collaboration']),
            ...
            [
                ...
                'interval' => 'month',
                'interval_count' => 1,
                'features' => json_encode(['Confirmation, reminder, and follow-up emails', 'Dedicated account manager', '24/7 support', 'Custom integrations']),
